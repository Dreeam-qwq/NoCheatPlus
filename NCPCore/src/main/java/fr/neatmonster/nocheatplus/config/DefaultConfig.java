...
public class DefaultConfig extends ConfigFile {
    ...
    public DefaultConfig() {
        ...
        set(ConfPaths.COMBINED_INVULNERABLE_IGNORE, Collections.singletonList("FALL"), 154);
        ...
        set(ConfPaths.INVENTORY_FASTCLICK_EXCLUDE, Collections.singletonList("Inventory Name Here"), 154);
        ...
        set(ConfPaths.COMPATIBILITY_EXEMPTIONS_WILDCARD_DEFAULT_METADATA_KEYS, Collections.singletonList("nocheat.exempt"), 154);
        ...
        set(ConfPaths.COMPATIBILITY_EXEMPTIONS_WILDCARD_NPC_METADATA_KEYS, Collections.singletonList("NPC"), 154);
